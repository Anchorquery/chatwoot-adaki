...
export const documentsList = [
  {
    ...
    id: 3059,
    name: 'How to use Conversation Filters? | User Guide | Adaki',
    status: 'available',
  },
  {
    account_id: 2,
    ...
    content:
      'Step-by-step guide for automating ticket assignments and improving support workflow in Adaki.',
    created_at: 1736143273,
    external_link:
      'https://www.chatwoot.com/hc/user-guide/articles/1677688200-automating-ticket-assignments',
    id: 3060,
    name: 'Automating Ticket Assignments | User Guide | Adaki',
    status: 'available',
  },
  {
    account_id: 3,
    ...
    id: 3061,
    name: 'Managing Customer Profiles | User Guide | Adaki',
    status: 'available',
  },
  {
    account_id: 4,
    ...
    id: 3062,
    name: 'Sales Tracking Guide | User Guide | Adaki',
    status: 'available',
  },
  {
    account_id: 5,
    ...
    id: 3063,
    name: 'Managing Tickets | User Guide | Adaki',
    status: 'available',
  },
  {
    account_id: 6,
    ...
    id: 3064,
    name: 'Financial Reporting | User Guide | Adaki',
    status: 'available',
  },
];
...
export const responsesList = [
  {
    ...
    id: 87,
    question: 'Why is my Messenger in Adaki deactivated?',
    status: 'pending',
    assistant: {
      account_id: 1,
      config: { product_name: 'Adaki' },
  ...
  },
  {
    ...
    id: 88,
    question: 'How do I integrate WhatsApp with Adaki?',
    assistant: {
      account_id: 2,
      config: { product_name: 'Adaki' },
  ...
  },
  {
    ...
    id: 89,
    question: 'How can I reset my password in Adaki?',
    assistant: {
      account_id: 3,
      config: { product_name: 'Adaki' },
  ...
  },
  {
    ...
    id: 90,
    question: 'How do I enable dark mode in Adaki?',
    assistant: {
      account_id: 4,
      config: { product_name: 'Adaki' },
  ...
  },
  {
    ...
    id: 91,
    question: 'How do I add a new team member in Adaki?',
    assistant: {
      account_id: 5,
      config: { product_name: 'Adaki' },
  ...
  },
  {
    account_id: 6,
    answer:
      "Campaigns in Adaki allow you to send targeted messages to specific user segments. You can create them in the 'Campaigns' section.",
    created_at: 1736283380,
    id: 92,
    question: 'What are campaigns in Adaki?',
    assistant: {
      account_id: 6,
      config: { product_name: 'Adaki' },
